...
Repositorio standalone da landing page de Deborah Costa.
...
- **Cliente:** Deborah Costa
- **GitHub:** https://github.com/emaildozotti/Deborah-Costa
- **Vercel:** https://deborah-costa.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Deborah Costa ao ar"
...
- O remote `origin` = `emaildozotti/Deborah-Costa` -- nao alterar
